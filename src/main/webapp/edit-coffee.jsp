    ...
    <div class="container">
        <div class="form-card">
            <div class="form-header">
                ...
                <h1>Edit Coffee Product</h1>
                <p>Update the details of ${coffee.name}</p>
            </div>

            <div class="coffee-info">
                <div class="info-row">
                    <div class="label">Product ID:</div>
                    <div class="value">#${coffee.id}</div>
                </div>
                <div class="info-row">
                    <div class="label">Current Price per kg:</div>
                    <div class="value">$${String.format("%.2f", coffee.pricePerKg)}/kg</div>
                </div>
                <div class="info-row">
                    <div class="label">Total Weight:</div>
                    <div class="value">${String.format("%.3f", coffee.totalWeight)} kg (coffee + packaging)</div>
                </div>
            </div>

            <form action="edit-coffee" method="post" id="coffeeForm">
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="type" name="type" value="${coffee.type}" required>
                </div>

                <div class="form-row">
                    <div class="form-group">
                        <label for="weight" class="required">Net Weight (kg)</label>
                        <input type="number" id="weight" name="weight" step="0.001" min="0.001"
                               value="${coffee.weight}" required>
                        <span class="form-hint">Weight of coffee without packaging</span>
                    </div>
                    <div class="form-group">
                        <label for="volume" class="required">Volume (m³)</label>
                        <input type="number" id="volume" name="volume" step="0.0001" min="0.0001"
                               value="${coffee.volume}" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="price" name="price" step="0.01" min="0.01"
                               value="${coffee.price}" required>
                        <span class="form-hint">Selling price per unit</span>
                    </div>
                    <div class="form-group">
                        <label for="packageWeight" class="required">Package Weight (kg)</label>
                        <input type="number" id="packageWeight" name="packageWeight" step="0.001" min="0"
                               value="${coffee.packageWeight}" required>
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="packageType" name="packageType" value="${coffee.packageType}" required>
                        <span class="form-hint">Type of packaging material</span>
                    </div>
                    <div class="form-group">
                        <label for="quantity" class="required">Quantity in Stock</label>
                        <input type="number" id="quantity" name="quantity" min="0" value="${coffee.quantity}" required>
                ...
                <div class="form-group">
                    <div id="pricePerKg" style="
                        ...
                        margin-top: 20px;
                    ">
                        <strong>Updated Price per Kilogram: </strong>
                        <span id="pricePerKgValue">$${String.format("%.2f", coffee.pricePerKg)}/kg</span>
                    </div>
                </div>
